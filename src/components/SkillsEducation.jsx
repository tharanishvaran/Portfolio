...
import { GraduationCap, Award, Code2, Terminal, Database, ExternalLink, Sparkles, Monitor } from 'lucide-react';
  ...
  return (
    <section id="skills" className="relative w-full bg-[#0a0a0a] text-white py-32 px-6 md:px-12 border-t border-neutral-900 overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* LeetCode Special Callout Banner */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mb-16 p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#181818] via-[#1a1313] to-[#181818] border border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl"
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#ff2a2a]/10 border border-[#ff2a2a]/30 flex items-center justify-center text-[#ff2a2a] shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-neutral-400">40+ Problems Solved</span>
              </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-6 py-3 rounded-full bg-white hover:bg-[#ff2a2a] text-black hover:text-white font-bold text-xs uppercase tracking-wider transition-all duration-300 flex items-center gap-2 shrink-0 shadow-lg hover:shadow-[0_0_25px_rgba(255,42,42,0.5)]"
          >
        ...
        <div className="mb-24">
          <h3 className="text-2xl font-extrabold font-display tracking-tight text-white mb-8 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {SKILL_CATEGORIES.map((cat, idx) => (
              <motion.div
                ...
                className="p-6 rounded-3xl bg-[#141414] border border-neutral-800/80 hover:border-[#ff2a2a]/50 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <h4 className="text-base font-bold font-display text-white border-b border-neutral-800 pb-3 mb-4">
                    {cat.title}
                  </h4>
                    ...
                    {cat.skills.map((s) => (
                      <div key={s.name} className="flex flex-col gap-0.5">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-[10px] font-mono text-[#ff2a2a]">{s.level}</span>
                        </div>
                        {s.highlight && (
                ...
                <div key={i} className="relative group">
                  ...
                  <div
                    className={`absolute -left-[31px] top-1.5 w-4 h-4 rounded-full border-2 transition-all ${
                      edu.current
                        ? 'bg-[#ff2a2a] border-white shadow-[0_0_12px_#ff2a2a]'
                        : 'bg-neutral-900 border-neutral-600 group-hover:border-[#ff2a2a]'
                    }`}
                  />

                  <div className="p-6 rounded-2xl bg-[#141414] border border-neutral-800/90 group-hover:border-neutral-700 transition-colors">
                    ...
                    <h4 className="text-lg font-bold font-display text-white">{edu.degree}</h4>
            ...
            <div className="space-y-6">
              {CERTIFICATIONS.map((cert, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: idx * 0.1 }}
                  className="p-6 rounded-2xl bg-[#141414] border border-neutral-800/90 hover:border-[#ff2a2a]/60 transition-all"
                >
              ...
              {/* Quick Contact Card */}
              <div className="p-6 rounded-2xl bg-gradient-to-br from-[#1a1313] to-[#121212] border border-[#ff2a2a]/30 text-center">
