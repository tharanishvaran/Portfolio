...
const PROJECTS = [
  ...
  {
    id: 'epms-pharma',
    title: 'Enterprise Pharmaceutical Management System (EPMS)',
    tagline: 'Multi-Tier Role-Based Healthcare Platform & POS Automation (Client Project)',
    category: 'Full-Stack Web App / Client Solution',
    featured: true,
    image: '/epms_preview.jpg',
    description:
      'Engineered an enterprise-grade, multi-tier pharmaceutical management platform for client operations to harmonize corporate governance, clinical relations, pharmacy dispensing, and supply chain logistics. Features zero-trust dual-layer RBAC across 8 organizational actors, automated batch & 90-day expiry surveillance, high-speed atomic POS dispensing, and field medical representative sales quota tracking.',
    highlights: [
      'Dual-layer zero-trust RBAC governing 8 distinct roles (Admin, Manager, Pharmacist, Cashier, Medical Rep, Vendor, Doctor, Customer)',
      'Automated batch & expiry surveillance with dynamic reorder thresholds & proactive 90-day shelf-life warnings',
      'High-speed atomic POS dispensing counter with server-validated stock depletion & compliant printable tax invoices',
      'Data-driven sales quota management tracking field doctor visits & automated rep target achievement metrics',
    ],
    tech: ['React 18', 'Node.js', 'Express', 'SQLite (WAL)', 'REST API', 'JWT', 'Vanilla CSS'],
    github: 'https://github.com/tharanishvaran',
    liveUrl: 'https://pharma-care-org.onrender.com',
